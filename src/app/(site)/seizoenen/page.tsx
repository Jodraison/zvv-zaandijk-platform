    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 max-w-xl text-sm text-zvv-muted">
          Kies het seizoen dat je wilt volgen. De seizoenskeuze in de header gebruikt dezelfde voorkeur.
        </p>
      </header>
          ...
          return (
            <GlassCard key={s.id} glow={active} className={active ? "border-zvv-primary/40" : ""}>
              <div className="flex items-start justify-between gap-3">
                <div>
                  <Badge tone={s.is_active ? "gold" : "muted"}>{s.is_active ? "Actief seizoen" : "Archief"}</Badge>
