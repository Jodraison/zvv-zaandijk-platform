...
const REQUIRED_COLUMNS: Record<string, string> = {
  ...
  matches: "id,season_id,opponent,kickoff_at,is_home,match_type,location,referee,notes,goals_for,goals_against,status,wotm_player_id",
  match_player_stats: "match_id,player_id,goals,assists",
  match_goal_events: "id,match_id,scorer_player_id,assist_player_id,sort_order,minute",
  match_card_events: "id,match_id,player_id,card_type,minute",
  match_substitutions: "id,match_id,player_in_id,player_out_id,minute",
  match_matchday_roster: "match_id,player_id,match_shirt_number,position_label",
  match_lineup_entries: "id,match_id,player_id,role,position,absence_reason,sort_order",
